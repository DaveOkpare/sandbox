...
describe.skip('generate.ts', () => {
  ...
  describe('copyClient', () => {
    ...
    it('should write to output directory', async () => {
      process.argv = ['node', 'generate.ts', '--config', JSON.stringify(mockServerConfig), '--output', '/custom'];
  ...
  describe('Edge cases', () => {
    ...
    it('should handle empty output directory path', async () => {
      process.argv = ['node', 'generate.ts', '--config', JSON.stringify(mockServerConfig), '--output', ''];
